...
import threading  # Importez le module threading pour exécuter l'appel API dans un thread séparé
import time
...
class LoginPage(tk.Frame):
  def __init__(self, parent):
    ...
    self.style.configure("PrimaryButton.TButton", padding=(10, 5), foreground="white", justify="center")
    self.button_login = ttk.Button(self, text="Connexion", command=self.login, style="PrimaryButton.TButton", width=12)
